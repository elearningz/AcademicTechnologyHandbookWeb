...
## ProctorU - Information and reminder of upcoming exam
...
<textarea id="announce2" style="width:99%;height:350px;">
ProctorU - Information and reminder of upcoming exam
...
<button class="btn btn-primary" data-clipboard-action="copy" data-clipboard-target="#announce2">Copy to Clipboard</button>
...
<textarea id="announce3" style="width:99%;height:350px;">
Guest Lecture for [TOPIC]
...
<button class="btn btn-primary" data-clipboard-action="copy" data-clipboard-target="#announce3">Copy to Clipboard</button>
